...
const INTENSITY_STYLES: Record<number, string> = {
  ...
  4: 'bg-[#4fc4c9] text-white hover:bg-[#45b5ba]',
  5: 'bg-[#2aa6ab] text-white hover:bg-[#24979b]',
};
...
function getIntensityLevel(noteCount: number) {
  ...
  if (noteCount <= 5) return 1;
  if (noteCount <= 10) return 2;
  if (noteCount <= 15) return 3;
  if (noteCount <= 20) return 4;
  return 5;
}
